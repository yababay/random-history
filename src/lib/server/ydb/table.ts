...
export class Tags extends TableDescription {
  constructor() {
    super();
    this.columns.push(new Column('tag', Types.UTF8))
    //this.columns.push(new Column('alter', Types.UTF8))
    this.withPrimaryKey('tag')
  }
} 
