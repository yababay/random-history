...
import { fileNameFromUrl, downloadImage, attachmentForChat, chatPost, attachmentForWall } from './upload'
...
describe('Wall post with image', () => {
    ...
    it('should upload', async () => {
        ...
        const attachment = await attachmentForWall(fn)
